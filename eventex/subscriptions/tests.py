...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Ivan Barabach',email.body)
        self.assertIn('12345678900',email.body)
        self.assertIn('ivan.barabach@gmail.com',email.body)
        self.assertIn('47-99971-4042',email.body)
...
class SubscribeSuccessMessage(TestCase):
    def test_message(self):
        data = dict(name='Ivan Barabach', cpf='12345678900',email='ivan.barabach@gmail.com', phone='47-99971-4042')
